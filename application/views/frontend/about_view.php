...
<head>
    <meta charset="utf-8">
    <!-- TITLE -->
    <title>Toko Bunga Sragen, Karangan Bunga Cantik dan Segar - Valen Florist</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="format-detection" content="telephone=no">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <link rel="shortcut icon" href="<?php echo base_url().'theme/images/favicon.png'?>"/>
	<meta name="description" content="Toko Bunga Sragen Valen Florist - Pesan Karangan Bunga Papan Murah dan Cantik. Pesan Online via Whatsapp. Cepat, Mudah, dan Murah. Bunga Cantik dan Segar. Kami buka 24 Jam Siap Melayani.">
