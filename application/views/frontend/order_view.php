...
<head>
    ...
    <meta name="description" content="Toko Bunga Sragen ValenFlorist Buka 24 Jam">
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <h3>A. Pemesanan produk rangkaian bunga kami dapat dilakukan melalui:</h3><br>
                <h4>Telepon/WhatsApp/SMS</h4>
                <p>Untuk pemesanan bunga melalui telepon/WhatsApp/SMS dapat dilakukan dengan menghubungi kontak kami yang tertera pada <a href='/valenflorist/contact/'>Contact US</a></p><br>
                <h4>Format Pemesanan Bunga :  </h4>
                    <p>Dengan memberikan informasi lengkap mengenai :<br>
                    1. Data Penerima bunga pesanan meliputi nama, no telepon, alamat lengkap, tanggal & jam pengiriman<br>
                    2. Ucapan / Pesan tertulis di karangan bunga yang dipesan<br>
                    3. Jenis bunga yang ingin di pesan<br>
                    4. Jumlah bunga yang ingin di pesan <br>
                    5. Kapan pesanan ingin di terima</p>
                <h3>B. Cara pembayaran : </h3>
                    <p>Silahkan hubungi kami melalui kontak yang tersedia untuk cara pembayaran<br>
                    <h3>C. Syarat dan ketentuan yang berlaku:</h3>
                    1. Pemesanan bunga bersifat mendadak (mis: Bunga Papan Duka Cita) membutuhkan waktu MINIMAL 1,5 jam sejak kami memperoleh konfirmasi order. (Apabila pesanan sedang tidak ramai.)<br>
                    2. Segera setelah pengiriman, kami akan mengirim foto, invoice dan surat jalan sebagai bukti pemesanan.<br>
                    3. Apabila ada kerusakan atau pesanan tidak sesuai diharapkan memfoto dan menceritakan detail kronologi nya. <br>
                    4. Apabila pesanan diluar kota diharapkan untuk melakukan pemesanan minimal H-1.</p><br>
                    <h3>Terimakasih telah mempercayai Valen Florist untuk pemesanan rangkaian bunga yang Anda dibutuhkan.</h3>
                ...
                <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/reservation_pantner/whatsapp.png'?>" alt="">
                            </div>
                            <div class="info">
                                <!-- GANTI DENGAN LINK TRAVELOKA HOTEL ANDA -->
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="https://wa.me/08111977252" target="_blank">Order With</a>
                            </div>
                        </div>
                    </div>
                        </div>
